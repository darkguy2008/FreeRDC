...
namespace FreeRDC.Services.Client
{
    public class HostConnection
    {
        ...
        {
            Connection.SendCommand(Connection.RemoteEndPoint, ID, new Commands.CLIENT_KEY_DOWN()
            {
                Alt = e.Alt,
                Control = e.Control,
                Handled = e.Handled,
                KeyCode = (short)e.KeyCode,
                KeyData = (short)e.KeyData,
                KeyValue = e.KeyValue,
                Modifiers = (short)e.Modifiers,
                Shift = e.Shift,
        ...
        {
            Connection.SendCommand(Connection.RemoteEndPoint, ID, new Commands.CLIENT_KEY_UP()
            {
                Alt = e.Alt,
                Control = e.Control,
                Handled = e.Handled,
